...
export default {
  ...
  methods: {
    ...
    cabezeraRecordAsigCupos() {
      this.headers = [
        { text: "Nombres", value: "datosPaciente.nombres" },
        { text: "Apellido Paterno", value: "datosPaciente.ape_pat" },
        { text: "Apellido Materno", value: "datosPaciente.ape_mat" },
        { text: "Clínica", value: "datosPueto.datosCas.descripCas" },
        {
          text: "Frecuencia",
          align: "start",
          sortable: false,
          value: "datosPueto.frecuencia",
        },
    ...
    buscarPacicente() {
      ...
      axios
        ...
        .then((response) => {
          ...
          axios
            .get(
              RUTA_SERVIDOR + "/APICNSR/asigCuposPac/?search=" + this.setDni,
              {
                headers: { Authorization: this.auth },
              }
            )
