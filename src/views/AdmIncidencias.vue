<template>
  <div>
    ...
    <div class="row">
      ...
      <div v-if="selectedItem == 0" class="col-sm-10"><AtencionIncidencias /></div>
    </div>
  </div>
</template>
...
import AtencionIncidencias from "./AtencionIncidencias.vue";
...
export default {
  data() {
    return {
      ...
      selectedItem: null,
      items2: [
        { text: "Atención Incidencias", icon: "mdi-folder" },
      ],
    };
  },
  methods: {},
